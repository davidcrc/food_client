...
import { addToCart, Item, removeFromCart, selectCartItemsById } from '@/slices/cartSlice';
...
const DishRow = ({ name, description, id, price, image }: DishRowProps) => {
  ...
  const cartItems = useSelector((state: RootState) => selectCartItemsById(state, id));
        ...
        <View className="flex flex-1 space-y-3">
          ...
          <View className="flex-row pl-3 justify-between items-center">
            ...
            <View className="flex-row items-center gap-2">
              ...
              <Text className="flex justify-center text-center w-5 ">{cartItems.length}</Text>
